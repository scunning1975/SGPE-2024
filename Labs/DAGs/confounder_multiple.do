* Multiple ways to satisfy the backdoor criterion, but some may still be better, not because of bias, but for precision.  Thanks to Kyle Butts for helping fix my code.
